...
const selectedSource = ref({
	source: routeSource.value?.source ?? HandlerSource,
	name: routeSource.value?.name ?? HandlerSource.name,
});
// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
const selectedBranch = ref(route.params.tag ?? HandlerSource.defaultTag);
