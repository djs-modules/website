<template>
	<code class="text-gray-200 bg-discord-blurple-560 p-4 md:text-lg mx-auto rounded-md shadow flex items-center"
		><span class="hover:text-white mr-2">npm install @badboy-discord/discordjs-handler</span>
...
const copyInstallCmd = async () => {
	try {
		await navigator.clipboard.writeText('npm install @badboy-discord/discordjs-handler');
		showTooltip();
	} catch {}
